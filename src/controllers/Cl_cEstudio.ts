...
export class Cl_cEstudio {
    private API_URL = 'https://6a1305d078d0434e0d5db973.mockapi.io/api/v1/estudios';
    ...
    public async obtenerTodos(): Promise<Cl_mEstudio[]> {
        try {
            ...
            return datos.map((e: any) => new Cl_mEstudio(e.nombre, Number(e.precio), e.valorReferencia, e.id));
        } catch (error) {
